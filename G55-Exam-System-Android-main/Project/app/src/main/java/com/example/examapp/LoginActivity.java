...
public class LoginActivity extends AppCompatActivity {
    ...
    private RelativeLayout gSigninB;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gSigninB = findViewById(R.id.g_signB);
        ...
        gSigninB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                googleSignIn();
            }
                            ...
                            if(!mAuth.getCurrentUser().isEmailVerified())
                            {
                                ...
                                user.sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        Toast.makeText(LoginActivity.this,"Verification Email has been sent in your email",Toast.LENGTH_SHORT).show();
                                    }
                                });
